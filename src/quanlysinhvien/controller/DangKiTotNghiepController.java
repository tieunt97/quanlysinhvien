...
public class DangKiTotNghiepController {
	...
	public DangKiTotNghiepController(PanelDangKiTotNghiepView dkTN, TaiKhoan tk) {
		...
		this.panelSVTC = dkTN.getPanelSVTC();
		this.panelSVNC = dkTN.getPanelSVNC();
	...
	private void setThongTin() {
		if(tk.getLoaiTK().equals("svtc")) {
			...
			labHoTen.setText(svnc.getHoTen());
			labTongSoKy.setText(Integer.toString(svnc.getTongSoKy()));
			labDiemTB.setText(Double.toString(svnc.getDiemTB()));
			panelSVNC.setVisible(true);
			panelSVTC.setVisible(false);
		}
	}
